...
var css = [
	...
	".framer-xISKZ.framer-1y64d0d { align-content: center; align-items: center; display: flex; flex-direction: column; flex-wrap: nowrap; gap: 20px; height: min-content; justify-content: center; overflow: hidden; padding: 0px 0px 10px 0px; position: relative; width: 100vw; }",
	".framer-xISKZ .framer-na4i6d-container, .framer-xISKZ .framer-1un43oa-container, .framer-xISKZ .framer-a52vve-container { flex: none; height: 250px; position: relative; width: 100%; overflow: visible; }",
