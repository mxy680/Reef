...
struct KaTeXView: UIViewRepresentable {
    ...
    private func loadContent(in webView: WKWebView) {
        guard let bundleURL = Bundle.main.resourceURL?.appendingPathComponent("KaTeX") else { return }
        ...
        <style>
          * { margin: 0; padding: 0; box-sizing: border-box; }
          ...
          .katex { font-size: 1.1em; white-space: nowrap; display: inline-block; }
          .katex-display { margin: 0.5em 0; overflow-x: auto; white-space: normal; }
