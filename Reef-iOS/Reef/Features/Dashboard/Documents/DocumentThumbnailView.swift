...
struct DocumentThumbnailView: View {
    ...
    var body: some View {
        ...
        return ZStack {
            Rectangle()
                .fill(status == .failed ? Color(hex: 0xFFF5F5) : (dark ? ReefColors.Dark.subtle : Color(hex: 0xFAFAFA)))
    ...
    private var ruledLines: some View {
        ...
        return GeometryReader { geo in
            ...
            ForEach(0..<lineCount, id: \.self) { i in
                ...
                .stroke(dark ? ReefColors.Dark.divider : ReefColors.gray100, lineWidth: 0.5)
            }
        }
    }
}
