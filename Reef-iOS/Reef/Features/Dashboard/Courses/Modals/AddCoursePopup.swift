...
struct AddCoursePopup: View {
    ...
    @State private var selectedColor: String = courseColorPresets[0]
    @FocusState private var isNameFocused: Bool

    init(onConfirm: @escaping (String, String, String) -> Void, onClose: @escaping () -> Void) {
        self.onConfirm = onConfirm
        self.onClose = onClose
        // Pre-select a random icon
        self._selectedIcon = State(initialValue: courseIconOptions.randomElement() ?? courseIconOptions[0])
    }
    ...
    var body: some View {
        ...
        VStack(alignment: .leading, spacing: 0) {
            ...
            HStack {
                ...
                ReefModalButton("Create", isEnabled: canCreate) {
                    submitIfValid()
                }
            }
        }
